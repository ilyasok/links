  ...
  return (
    <div className="faq-content">
      ...
      <DetailsSummary title="Где найти шаблоны, программы и плагины?">
        ...
        <AdditionDanger>
          Устанавливая софт или плагины из каналов Устанавливая содержимое на ваше
          устройство из каналов <a href="https://t.me/s/designworld">Design World</a>,{" "}
          ...
          <mark>ой в складе, саде или дизайн ворлде одни вирусы водятся</mark> на полном
