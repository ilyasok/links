      ...
      >
        ...
        <ul>
          ...
          <li>
            ...
            <AdditionInfo>
              Если у вашего исходного видео битрейт составляет 10 Мбит, а при экспорте вы
              укажете 50 Мбит, то качество изображения не улучшится. Вы просто увеличите
              размер файла без реальной пользы.
            </AdditionInfo>
            ...
            <ul>
              ...
              <li>
                CQ-квантирование (Constant Quantization) — это метод сжатия видео, где
                уровень качества изображения сохраняется постоянным на протяжении всего
                видео, независимо от его сложности. Чем меньше значение, тем лучше
                качество изображения, но больше вес.
              </li>
              <li>
          ...
          <li>
            ...
            виду плагины от компании Boris FX. В частности, это известные пакеты{" "}
          ...
          <li>
            <mark className="file">Прокси</mark> - урезанная в качестве (зависит от того,
