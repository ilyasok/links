    ...
    >
      ...
      <DetailsSummary title="Не понимаю термины от других пользователей программы, проясните!">
        <p>
          ...
          свой сленг и понятия. В этом списке постараемся объяснить частоиспользуемые
          термины и слова.{" "}
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            маски или фигуры на основе крёв вашего слоя. Данную функцию можно вызвать в{" "}
            <mark className="ui">Layer &gt; Auto-Trace</mark>
          </li>
          <li>
            <mark className="word">Битрейт</mark> - скорость передачи и обработки
            информации видеофайла в некой системе единиц. Чаще всего выражается в{" "}
            ...
            показываются быстродвижущиеся объекты).{" "}
            <AdditionInfo>
          ...
          <li>
            ...
            многоугольники). Отличительная особеннность такого типа изображений -
            детализация не падает при увеличении масштаба холста.
            <AdditionInfo>
              Если вы нажмёте на <mark className="ui">Continously Rasterize</mark> у слоя
          ...
          <li>
            <mark className="word">ЕМНИМ</mark> - сокращения от выражения{" "}
          ...
          <li>
            ...
            <mark className="word">немонтажные (delivery) кодеки</mark>. Видео с
            немонтажными кодеками для монтажа вашего видео использовать не рекомендуется.
            <ul>
              <p
              ...
              <li>
                <mark className="file">GoPro Cineform</mark> - также популярен в
                киноиндустрии и на телевидении, поддерживает вывод видео с альфа-каналом и
                также имеет меньший вес по сравнению с{" "}
            ...
            <ul>
              ...
              <li>
                ...
                <AdditionDanger>
                  ...
                  своих серверах, но не расчитывает на то, что пользователь скачает видео
              ...
              <li>
                ...
                Blu-ray диск, чтобы воспроизвести это видео с помощью видеопроигрывателя
                или дисковода.
              </li>
            </ul>
          </li>
          <li>
            <mark className="word">Контейнер</mark> - расширение видеофайла, в котором
          ...
          <li>
            <mark className="word">Коллект файлс</mark> - функция{" "}
          ...
          <li>
            ...
            превращения одной фигуры в другую, часто применяется с шейповыми слоями.
          </li>
          <li>
          ...
          <li>
            <mark className="word">Одинаковый год</mark> - часто встречается в контекте
          ...
          <li>
            ...
            или медленно) или плохое качество предпросмотра (Auto или Quater вместо Full).
          </li>
          <li>
          ...
          <li>
            ...
            <mark className="ui">Third</mark> или <mark className="ui">Quater</mark>
            <AdditionInfo>
          ...
          <li>
            ...
            настройке размытия в движении. Чем больше семлов, тем лучше картинка, но хуже
            производительность.
          </li>
          <li>
          ...
          <li>
            ...
            <mark className="ui">Continously Rasterize</mark> для уменьшения
            &quot;пикселей&quot; у векторных объектов.
            <AdditionInfo>
              При включенной опции <mark className="ui">Continously Rasterize</mark> у
          ...
          <li>
            <mark className="word">Топикстартер</mark> - человек, который изначально задал
            вопрос или поднял определённую тему в чате.
          </li>
          <li>
          ...
          <li>
            <mark className="word">Трекинг</mark> - механизм опеределения местоположения
          ...
          <li>
            <mark className="word">Экстеншон</mark> - расширения, часто запакованные в{" "}
