...
export const AEInterface: React.FC = () => {
  return (
    ...
    >
      ...
      <DetailsSummary title="У меня график скорости отличается от того, что у другого пользователя. Как мне сделать 'нормальный вид' графика?">
        <p>{/* fixme: написать!! */}</p>
      </DetailsSummary>
      ...
      <DetailsSummary title="Установил After Effects 23.4 или выше. Бесит окно 'Properties', как его отключить?">
        <p>{/* fixme: написать!! */}</p>
      </DetailsSummary>
