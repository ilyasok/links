...
const AEInterface: React.FC = () => {
  return (
    <div className="faq-content">
      ...
      >
        <p>
          В версиях 2023 и новее пришла новая эпоха работы с масками. После обновления
          работа с слоями-масками стала проще. Но появилась другая проблема - старые
          обучающие видео вводят новичков с новыми версиями в заблуждение, а новые видео -
          пользователей с старыми версиями <mark className="app">After Effects</mark>.
          Поэтому постарайтесь найти более актуальные видео или приспособьтесь к немного
          другой реализации работы с масками.
        </p>
        <YouTubeVideo
          link="2Fi57LLJrUE"
