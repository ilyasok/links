    ...
    <div className="faq-content">
      ...
      <DetailsSummary title="Для чего нужен файл подкачки в Windows и почему его не стоит отключать?">
        <p>
          ...
          <mark className="file">pagefile.sys</mark> - это виртуальная оперативная память,
          которая используется операционной системой для разгрузки физической оперативной
          памяти компьютера при повышенных нагрузках. По умолчанию, если у вас не
          установлена чья-то сборка <mark>Windows</mark>, в которой она отключена, файл
          подкачки регулирует сама система и не всегда она хорошо это делает, лучше самому
          настроить максимальный размер файла подкачки.
        </p>
        <p>
          Отключение файла подкачки может привести к различным проблемам в{" "}
          <mark className="app">After Effects</mark> в виде{" "}
          <mark className="ui">
          ...
          . Также при переполнении оперативной памяти и отсутствии файла подкачки вы
          можете столкнуться с другими проблемами, как вылеты программ в фоне, ошибка{" "}
          <mark className="ui">В системе недостаточно памяти</mark> или вообще может
          появиться чёрный экран, который решается только перезагрузкой системы.
        </p>
        <p>
