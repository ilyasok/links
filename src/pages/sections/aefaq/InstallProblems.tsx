...
const AEInstallProblems: React.FC = () => {
  return (
    <div className="faq-content">
      ...
      <DetailsSummary
        title='"Не удаётся найти helper.exe", "Обнаружены угрозы", куда-то пропадают файлы плагинов и программ или как отключить Windows Defender?'
      ...
      <DetailsSummary title='Скачал репак от KpoJluK, при его открытии мне пишут "Некоторые установочные файлы были повреждены"'>
        <p>
      ...
      <DetailsSummary title='Скачал репак от KpoJluK, при его открытии мне утверждают, что "rsload.net заблокирован в hosts"'>
        <p>
