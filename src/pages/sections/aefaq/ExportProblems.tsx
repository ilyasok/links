  ...
  return (
    <div className="faq-content">
      ...
      <DetailsSummary title="Экспортировал композицию и вижу в результате ужасный ступенчатый градиент. Как мне от него избавиться?">
        ...
        <AdditionDanger>
          Приведённые способы решения не помогут полностью избавиться от полосатости на
          изображении из-за технических особенностей мониторов и цветовых пространств.
        </AdditionDanger>
      </DetailsSummary>
