        ...
        <ul>
          ...
          <li>
            ...
            <AdditionWarning>
              ...
              вам следовать этому вредному совету. Не забывайте, что системе при
              отключенном файле подкачки будет некуда выгружать неиспользуемую оперативную
              ...
              выдаёт сама операционная система.
            </AdditionWarning>
          </li>
          <li>
