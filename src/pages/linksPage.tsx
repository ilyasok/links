          ...
          <AdditionDanger>
            ...
            <ul>
              ...
              <li>
                ...
                <a href="https://www.fl.ru/">FL</a> или аналогичной - старайтесь не
                покидать диалог с клиентом вне биржи. Некоторые площадки блокируют
                исполнителей и заказчиков, которые просят перенести диалог в{" "}
                <mark className="app">Telegram</mark>,{" "}
                <mark className="app">Whatsapp</mark> или другой мессенджер/социальную
                сеть, а оно вам это явно не надо. Оно и понятно, диалог вне биржи не
                регулируется и никто в таком случае не гарантирует вам возврат средств в
                случае обмана.
              </li>
              <li>
                Всегда проверяйте профиль заказчика или исполнителя, если вы взяли заказ в
                социальной сети или мессенджере. Просите поставить имя и никнейм, если он
                отсутствует.
              </li>
              <li>
                ...
                признак бота-скамера!
              </li>
            </ul>
            <AdditionWarning>
              <b style={{fontSize: "1.25em", lineHeight: "1.25"}}>
                ...
                факте мошенничества. Если ваши данные были похищены - немедленно
                заблокируйте банковскую карту и перевыпустите её в банковском приложении!
              </b>
            </AdditionWarning>
          </AdditionDanger>
          <div className="links-grid">
