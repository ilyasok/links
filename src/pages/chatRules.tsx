        ...
        <div className="faq-container">
          ...
          <section className="faq-section">
            <div className="faq-content">
              ...
              <AdditionInfo>
                Если ваш вопрос остался не замеченным, не надо жаловаться и ныть об этом.
          ...
          <section className="faq-section">
            <div className="faq-content">
              ...
              <p>
                ...
                являются победителями &quot;Битвы экстрасенсов&quot; и не могут понять в
                чём у вас там проблема или в чём заключается ваша просьба помощи. Пустые
                вопросы, которые подразумевают вопросы в ответ - тратят время и на них
                тупо не хочется отвечать. Иначе н&amp;#%я вы пришли в чат? Просто привлечь
                внимание и тянуть своё время?
              </p>
              <p>
                Из-за ваших мета-вопросов вы не получите внятного ответа, пока не
                объясните ваш вопрос полностью. Также таким образом вы тянете себе время.
              </p>
              <AdditionWarning>
