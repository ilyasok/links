            ...
            <div className="faq-content">
              ...
              <div className="message-flex">
                <div className="message-incorrect">
                  ...
                  <div style={{opacity: 0.5, fontSize: "10px", textAlign: "center"}}>
                    Время переписки около 5-15 минут
                    <br />
              ...
              <p>
                ...
                имеется чёткий и сформулированный вопрос, вследствии чего любой участник
              ...
              <p>
                ...
                объясните ваш вопрос полностью. Также таким образом вы тянете время и
                себе, и другим участникам чата.
              </p>
              <AdditionWarning>
